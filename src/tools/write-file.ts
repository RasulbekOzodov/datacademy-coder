...
export const writeFileTool: Tool = {
  name: 'write_file',
  description:
    'Create a new file or completely overwrite an existing one with the given content. Parent directories are created. For small changes to existing files prefer edit_file.',
  permission: 'write',
  parameters: {
    type: 'object',
    properties: {
